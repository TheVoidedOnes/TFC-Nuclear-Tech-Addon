...
public class CraftingRecipesRegistry {
    ...
    private static final List<ResourceLocation> RECIPES_TO_REMOVE = Arrays.asList(
            ...
            new ResourceLocation("hbm", "anvil_lead"),
            new ResourceLocation("hbm", "billet_zfb_bismuth"),
            new ResourceLocation("hbm", "deuterium_filter"),
            new ResourceLocation("hbm", "gas_mask_filter_mono"),
            new ResourceLocation("hbm", "gas_mask_filter_combo"),
            new ResourceLocation("hbm", "titanium_helmet"),
            new ResourceLocation("hbm", "titanium_plate"),
            new ResourceLocation("hbm", "titanium_legs"),
            new ResourceLocation("hbm", "titanium_boots"),
            new ResourceLocation("hbm", "titanium_pickaxe"),
            new ResourceLocation("hbm", "titanium_axe"),
            new ResourceLocation("hbm", "titanium_shovel"),
            new ResourceLocation("hbm", "titanium_hoe"),
            new ResourceLocation("hbm", "titanium_sword"),
            new ResourceLocation("hbm", "cobalt_helmet"),
            new ResourceLocation("hbm", "cobalt_plate"),
            new ResourceLocation("hbm", "cobalt_legs"),
            new ResourceLocation("hbm", "cobalt_boots"),
            new ResourceLocation("hbm", "cobalt_sword"),
            new ResourceLocation("hbm", "cobalt_pickaxe"),
            new ResourceLocation("hbm", "cobalt_axe"),
            new ResourceLocation("hbm", "cobalt_hoe"),
            new ResourceLocation("hbm", "cobalt_shovel"),
            new ResourceLocation("hbm", "ball_resin"),
            new ResourceLocation("hbm", "gear_large"),
            new ResourceLocation("hbm", "gear_large_1")
    ...
    private static void registerAllRecipes() {
        ...
        new RecipeBuilder("machine_furnace_brick_off", item("hbm:machine_furnace_brick_off"))
                .shape("BBB/BCB/SSS",
                        ...
                        'S', ore("stoneBrick"),
                        'C', item("hbm:steel_grate")).register();
        ...
        new RecipeBuilder("anvil_iron", item("hbm:anvil_iron"))
                .shape("WWW/ D /WWW",
                        'W', ore("ingotDoubleWroughtIron"),
                        'D', ore("ingotDoubleBlackSteel")).register();
        new RecipeBuilder("anvil_lead", item("hbm:anvil_lead"))
                .shape("WWW/ D /WWW",
                        'W', ore("ingotDoubleLead"),
                        'D', ore("ingotDoubleBlackSteel")).register();
        ...
        new RecipeBuilder("ducrete_brick_3", item("hbm:ducrete_brick"))
                .shape("MDM/DLD/MDM",
                        ...
                        'M', ore("mortar"),
                        'L', ore("plateLead")).register();
        new RecipeBuilder("billet_zfb_bismuth", item("hbm:billet_zfb_bismuth"))
                .shape("ZZZ/UPB/   ",
                        'Z', ore("tinyZirconium"),
                        'U', ore("nuggetUranium"),
                        'P', ore("nuggetPlutonium241"),
                        'B', item("hbm:nugget_bismuth")).register();
        new RecipeBuilder("deuterium_filter", item("hbm:deuterium_filter"))
                .shape("RSR/SCS/RSR",
                        'R', ore("ingotAnyResistantAlloy"),
                        'C', item("tfcnuclear:fired_catalyst_clay"),
                        'S', item("hbm:sulfur")).register();
        new RecipeBuilder("gas_mask_filter_mono", item("hbm:gas_mask_filter_mono"))
                .shape("ZWZ/WGW/ZWZ",
                        'W', ore("ingotWroughtIron"),
                        'Z', ore("tinyZirconium"),
                        'G', item("tfc:glue")).register();
        new RecipeBuilder("gas_mask_filter_combo", item("hbm:gas_mask_filter_combo"))
                .shape("ZWZ/GFG/ZWZ",
                        'W', ore("ingotWroughtIron"),
                        'Z', ore("ingotZirconium"),
                        'G', item("tfc:glue"),
                        'F', item("hbm:gas_mask_filter")).register();
        new RecipeBuilder("ball_resin", item("hbm:ball_resin"))
                .shape("DD/DD",
                        'D', item("tfc:plants/dandelion")).register();

        new RecipeBuilder("gear_large", item("hbm:gear_large"))
                .shape("SSS/SBS/SSS",
                        'S', item("hbm:plate_iron"),
                        'B', item("tfc:brass_mechanisms")).register();
        new RecipeBuilder("gear_large_1", item("hbm:gear_large", 1, 1))
                .shape("SSS/SBS/SSS",
