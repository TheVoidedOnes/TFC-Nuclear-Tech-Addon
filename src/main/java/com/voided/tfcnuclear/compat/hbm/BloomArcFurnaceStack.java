...
public class BloomArcFurnaceStack extends ComparableStack {

    public final int metalAmount;
    public final Metal metal;

    public BloomArcFurnaceStack(Item item, int metalAmount, Metal metal) {
    ...
    public BloomArcFurnaceStack(ItemStack stack) {
        super(stack);
    ...
    public ComparableStack copy() {
        return new BloomArcFurnaceStack(item, metalAmount, metal);
    }
    ...
    public boolean equals(Object obj) {
        ...
        BloomArcFurnaceStack that = (BloomArcFurnaceStack) obj;
